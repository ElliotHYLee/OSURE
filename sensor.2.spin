...
OBJ
  ...
  math : "FloatMath"
PUB TestMPU  | MPUcog, currentAx, currentAy, currentAz, normX, normY, normZ, norm_tot
  ...
  repeat
   ...
   ' debug.str(string("]"))
    ...
    debug.str(string("]"))
    debug.tx(13)
    norm_tot := math.fsqr((GetAX*GetAX)+(GetAY*GetAY)+(GetAZ*GetAZ))
    debug.str(string("norm - "))
    debug.dec(norm_tot)
    debug.str(string(" "))
    ...
    'debug.str(string(" "))
    'currentGx := GetCX
    'normX := currentGx*currentGx 
    'debug.str(string("cy-")) 
    'debug.dec(GetCY)
    'debug.str(string(" "))
    'currentGy := GetCY
    'normY := currentGy*currentGy
    'debug.str(string("cz-")) 
    'debug.dec(GetCZ)
    'debug.str(string(" "))
    'currentGz := GetCZ
    'normZ := currentGz*currentGz
    'debug.tx(13)
    'norm_tot := math.fsqr(normX+normY+normZ)
    'debug.str(string("norm-"))
    'debug.dec(norm_tot)
    'debug.str(string(" "))
